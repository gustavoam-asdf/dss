...
public class CryptographicSuiteCatalogueTest {
    ...
    void digestAlgorithmUsagesTest() {
        ...
        assertEquals(expectedSet, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableDigestAlgorithms().keySet());
        ...
        assertEquals(emptySet, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableDigestAlgorithms().keySet());
        ...
        assertEquals(sha256Set, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableDigestAlgorithms().keySet());
    }
    ...
    void signatureAlgorithmUsagesTest() {
        ...
        assertEquals(expectedSet, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableSignatureAlgorithms().keySet());
        ...
        assertEquals(emptySet, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableSignatureAlgorithms().keySet());
        ...
        assertEquals(sha256Set, cryptographicSuiteCatalogue.getEAAPresentationCryptographicSuite().getAcceptableSignatureAlgorithms().keySet());
    }
