...
* *EAA creation webservices* (`dss-eaa-creation-soap` / `dss-eaa-creation-rest`) and their clients: expose methods to allow remote EAA creation, by providing payload or payload configuration and signature parameters, disclosures extraction based on parameters, key binding signature creation and EAA Presentation issuance.
* *EAA validation webservices* (`dss-eaa-validation-soap` / `dss-eaa-validation-rest`) and their clients: expose methods to allow validation of EAA Presentations.
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/1/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/2/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/3/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/4/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/5/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-and-eaa-presentation/6/curl-request.adoc[Request]
...
* *JSON*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/request-body.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/response-body.adoc[Response]
* *HTTP*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/http-request.adoc[Request] | https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/http-response.adoc[Response]
* *HTTPie*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/httpie-request.adoc[Request]
* *Curl*: https://github.com/esig/dss/blob/master/dss-cookbook/src/main/asciidoc/_restdocs/eaa-validation/1/curl-request.adoc[Request]
...
SOAP EAA creation service's client is initialized using `SoapEAACreationService` class.
...
SOAP EAA validation service's client is initialized using `SoapEAAValidationService` class.
