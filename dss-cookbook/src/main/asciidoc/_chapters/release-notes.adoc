...
|v6.5.RC1          |July 2026              a|Main new features / improvements :
                                            ...
                                            * Creation of Electronic Attestation of Attribute Presentations (EAAP) in SD-JWT VC <<R36>> & ISO/IEC-mdoc <<R38>>;
                                            * Validation of Electronic Attestation of Attribute Presentations (EAA) based in SD-JWT VC <<R36>> and ISO/IEC-mdoc <<R38>> as per ETSI TS 119-472-1 <<R34>>;
                                            * EAA Qualification validation (QEAA, PuB-EAA, PID);
                                            * EAA revocation verification (Token Status List, Identifiers List);
                                            ...
                                            * REST and SOAP webservices for EAA creation and validation;
                                            ...
                                            * Demos : New page in the webapp for validation of EAAs;
