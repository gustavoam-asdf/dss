...
|v6.5.RC1          |July 2026              a|Main new features / improvements :
                                            ...
                                            * Creation of Electronic Attestation of Attribute Presentations (EAAP) on SD-JWT VC <<R36>> & ISO/IEC-mdoc <<R38>>;
                                            * Validation of Electronic Attestation of Attributes (EAA) based on SD-JWT VC <<R36>> and ISO/IEC-mdoc <<R38>> as per ETSI TS 119-472-1 <<R34>>;
