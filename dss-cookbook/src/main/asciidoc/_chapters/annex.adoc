...
Trusted Lists and List(s) of Trusted Lists are cached automatically as a part if `ValidationJob` (see <<tlValidationJob>>). To configure it you may use `FileCacheDataLoader` (see <<DSSFileLoader>>).
