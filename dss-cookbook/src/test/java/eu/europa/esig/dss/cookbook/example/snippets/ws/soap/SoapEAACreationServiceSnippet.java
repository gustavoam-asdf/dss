...
public class SoapEAACreationServiceSnippet extends CookbookTools {
    ...
    public void demo() throws Exception {
        ...
        try (SignatureTokenConnection signingToken = getPkcs12Token()) {
            ...
            SoapEAACreationService soapClient = new SoapEAACreationServiceImpl();
            ...
            ToBeSignedDTO dataToSign = soapClient.getDataToSign(dataToSignEAADTO);
            ...
            RemoteDocument signedEAA = soapClient.signEAA(signEAADTO);
            ...
            RemoteDocument eaaPresentation = soapClient.issuePresentation(issuePresentationDTO);
        }
