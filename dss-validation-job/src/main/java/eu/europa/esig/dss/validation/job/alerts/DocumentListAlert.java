...
/**
 * The class to process events on a document list
 */
public class DocumentListAlert extends AbstractAlert<DocumentListInfo> {
	 ...
	 */
	public DocumentListAlert(AlertDetector<DocumentListInfo> detection, AlertHandler<DocumentListInfo> handler) {
