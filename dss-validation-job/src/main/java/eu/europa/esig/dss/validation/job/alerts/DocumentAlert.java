 ...
 */
public class DocumentAlert extends AbstractAlert<DocumentInfo> {
	 ...
	 */
	public DocumentAlert(AlertDetector<DocumentInfo> detection, AlertHandler<DocumentInfo> handler) {
