...
public final class CacheAccessFactory {
	 ...
	 *
	 * @return {@link DocumentChangesCacheAccess}
	 */
	public DocumentChangesCacheAccess getTLChangesCacheAccess() {
		return new DocumentChangesCacheAccess(downloadCache, parsingCache, validationCache);
	}
