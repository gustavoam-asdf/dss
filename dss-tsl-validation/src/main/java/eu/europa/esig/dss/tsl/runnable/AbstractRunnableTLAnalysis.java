...
public abstract class AbstractRunnableTLAnalysis extends AbstractRunnableAnalysis {
    ...
    protected TLParsingCacheDTO toParsingDTO(CachedEntry<ParsingResult> parsingCacheEntry) {
        return new TLParsingCacheDTOBuilder(parsingCacheEntry).build();
    }

    protected ValidationInfoRecord toValidationDTO(CachedEntry<ValidationResult> validationCacheEntry) {
