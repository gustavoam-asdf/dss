...
public enum SignatureLevel {
	...
	CBOR_NOT_ETSI, CBAdES_BASELINE_B, CBAdES_BASELINE_T, CBAdES_BASELINE_LT, CBAdES_BASELINE_LTA,
	...
	public SignatureForm getSignatureForm() {
		switch (this) {
			...
			case CBOR_NOT_ETSI:
			case CBAdES_BASELINE_B:
			case CBAdES_BASELINE_T:
			case CBAdES_BASELINE_LT:
			case CBAdES_BASELINE_LTA:
