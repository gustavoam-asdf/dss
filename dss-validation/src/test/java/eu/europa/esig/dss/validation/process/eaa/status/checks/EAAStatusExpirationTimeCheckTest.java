...
class EAAStatusExpirationTimeCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        xmlEAAStatusToken.setExpirationTime(new Date());
        XmlSAV result = new XmlSAV();

        EAAStatusExpirationTimeCheck eaasetc = new EAAStatusExpirationTimeCheck(
