...
class EAAStatusTokenTypeCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        xmlEAAStatusToken.setType("statuslist+jwt");
        XmlFC result = new XmlFC();

        EAAStatusTokenTypeCheck eaattc = new EAAStatusTokenTypeCheck(
    ...
    void invalidTest() {
        ...
        XmlEAAStatusToken xmlEAAStatusToken = new XmlEAAStatusToken();
        xmlEAAStatusToken.setType("statuslist+cwt");
        XmlFC result = new XmlFC();
