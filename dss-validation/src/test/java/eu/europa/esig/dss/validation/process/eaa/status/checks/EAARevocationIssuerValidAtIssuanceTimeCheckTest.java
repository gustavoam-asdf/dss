...
class EAARevocationIssuerValidAtIssuanceTimeCheckTest extends AbstractTestCheck {
    ...
    void validTest() {
        ...
        EAARevocationIssuerValidAtIssuanceTimeCheck eaasivaitc = new EAARevocationIssuerValidAtIssuanceTimeCheck(
