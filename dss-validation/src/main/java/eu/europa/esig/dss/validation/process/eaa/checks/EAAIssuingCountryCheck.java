 ...
 *
 */
public class EAAIssuingCountryCheck extends AbstractMultiValuesCheckItem<XmlValidationProcessEAA> {
     ...
     */
    public EAAIssuingCountryCheck(I18nProvider i18nProvider, XmlValidationProcessEAA result,
