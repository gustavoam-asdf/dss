 ...
 *
 */
public class EAAIssuingAuthorityCheck extends AbstractMultiValuesCheckItem<XmlSAV> {
     ...
     */
    public EAAIssuingAuthorityCheck(final I18nProvider i18nProvider, final XmlSAV result,
