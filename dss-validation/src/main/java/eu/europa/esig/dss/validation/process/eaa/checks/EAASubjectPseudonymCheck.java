 ...
 *
 */
public class EAASubjectPseudonymCheck extends AbstractMultiValuesCheckItem<XmlValidationProcessEAA> {
     ...
     */
    public EAASubjectPseudonymCheck(final I18nProvider i18nProvider, final XmlValidationProcessEAA result,
