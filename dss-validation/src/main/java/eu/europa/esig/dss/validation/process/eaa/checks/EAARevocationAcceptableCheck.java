 ...
 *
 */
public class EAARevocationAcceptableCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAARevocationAcceptableCheck(final I18nProvider i18nProvider, final XmlSAV result,
                                        final EAARevocationWrapper eaaStatusToken, final XmlConclusion conclusion, final LevelRule constraint) {
