...
/**
 * Verifies whether the EAA status token contains an issuance time
 *
 */
public class EAAStatusIssuanceTimeCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAAStatusIssuanceTimeCheck(I18nProvider i18nProvider, XmlSAV result,
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_STATUS_ISS;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_STATUS_ISS_ANS;
    }
