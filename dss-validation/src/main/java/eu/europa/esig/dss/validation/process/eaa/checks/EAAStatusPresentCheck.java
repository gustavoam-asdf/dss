 ...
 *
 */
public class EAAStatusPresentCheck extends ChainItem<XmlValidationProcessEAA> {
     ...
     */
    public EAAStatusPresentCheck(final I18nProvider i18nProvider, final XmlValidationProcessEAA result,
