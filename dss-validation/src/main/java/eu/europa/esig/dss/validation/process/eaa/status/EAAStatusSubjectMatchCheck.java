...
/**
 * Verifies whether the EAA status token's subject matches to the subject of the related EAA
 *
 */
public class EAAStatusSubjectMatchCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAAStatusSubjectMatchCheck(I18nProvider i18nProvider, XmlSAV result, EAAStatusTokenWrapper eaaStatusToken,
    ...
    protected MessageTag getMessageTag() {
        return MessageTag.EAA_STATUS_SUB_MATCH;
    }

    @Override
    protected MessageTag getErrorMessageTag() {
        return MessageTag.EAA_STATUS_SUB_MATCH_ANS;
    }
