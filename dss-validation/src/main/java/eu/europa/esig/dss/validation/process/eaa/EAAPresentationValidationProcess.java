...
public class EAAPresentationValidationProcess extends Chain<XmlValidationProcessEAAPresentation> {
    ...
    private ChainItem<XmlValidationProcessEAAPresentation> eaaType() {
        MultiValuesRule constraint = policy.getEAAPresentationEAATypeConstraint();
        return new EAATypeCheck(i18nProvider, result, eaaPresentation, constraint);
    }

    private ChainItem<XmlValidationProcessEAAPresentation> typeIntegrityPresent() {
        LevelRule constraint = policy.getEAAPresentationEAATypeIntegrityPresentConstraint();
        return new EAATypeIntegrityPresentCheck(i18nProvider, result, eaaPresentation, constraint);
    }

    private ChainItem<XmlValidationProcessEAAPresentation> notBeforePresent() {
        LevelRule constraint = policy.getEAAPresentationEAANotBeforePresentConstraint();
        return new EAANotBeforePresentCheck(i18nProvider, result, eaaPresentation, constraint);
    }

    private ChainItem<XmlValidationProcessEAAPresentation> expirationPresent() {
        LevelRule constraint = policy.getEAAPresentationEAAExpirationPresentConstraint();
        return new EAAExpirationPresentCheck(i18nProvider, result, eaaPresentation, constraint);
    }

    private ChainItem<XmlValidationProcessEAAPresentation> administrativeIssuanceDatePresent() {
        LevelRule constraint = policy.getEAAPresentationEAAAdministrativeIssuanceDatePresentConstraint();
        return new EAAAdministrativeIssuanceDatePresentCheck(i18nProvider, result, eaaPresentation, constraint);
    }
    ...
    private ChainItem<XmlValidationProcessEAAPresentation> etsi194721Conformance() {
        LevelRule constraint = policy.getEAAPresentationEAAETSI194721ConformanceConstraint();
        return new ETSI194721ConformanceCheck(i18nProvider, result, eaaPresentation, constraint);
    }
