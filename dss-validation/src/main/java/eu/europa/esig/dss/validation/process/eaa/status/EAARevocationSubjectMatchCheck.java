 ...
 *
 */
public class EAARevocationSubjectMatchCheck extends ChainItem<XmlSAV> {
     ...
     */
    public EAARevocationSubjectMatchCheck(I18nProvider i18nProvider, XmlSAV result, EAARevocationTokenWrapper eaaStatusToken,
