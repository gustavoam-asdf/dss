...
class CBAdESExtensionLTClearToLTATest extends AbstractCBAdESTestSignature {
    ...
    protected DSSDocument sign() {
        ...
        assertEquals("Unable to extend CB-AdES-BASELINE-LTA level. " +
                        "Clear 'uHeaders' incorporation requires a canonicalization method!",
