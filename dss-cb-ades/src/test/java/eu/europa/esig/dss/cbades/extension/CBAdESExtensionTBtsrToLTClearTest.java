...
class CBAdESExtensionTBtsrToLTClearTest extends AbstractCBAdESTestSignature {
    ...
    protected DSSDocument sign() {
        ...
        assertEquals("Extension is not possible! The encoding of 'uHeaders' components shall match! " +
                        "Use cbadesSignatureParameters.setCborByteStringWrapperComponents(true)",
                exception.getMessage());

        DSSDocument convertedDocument = CBAdESConverter.fromUHeadersWithBtsrToClearIncorporation(signedDocument);
